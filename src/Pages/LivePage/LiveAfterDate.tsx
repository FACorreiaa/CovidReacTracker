    ...
    datasets: [
      {
        ...
        data: !country
          ? null
          : data[0].name.map((n: ILiveData) => n.name.Active),
      },
      {
        label: "Recovered",
        ...
        data: !country
          ? null
          : data[0].name.map((n: ILiveData) => n.name.Recovered),
      },
      {
        label: "Deaths",
        ...
        data: !country
          ? null
          : data[0].name.map((n: ILiveData) => n.name.Deaths),
      },
      {
        label: "Confirmed",
        ...
        data: !country
          ? null
          : data[0].name.map((n: ILiveData) => n.name.Confirmed),
      },
    ],
  };
