...
export default function SummaryTotalDeaths() {
  const url = `${process.env.REACT_APP_BASE_URL}/countriessummary/total/deaths`;
    ...
    datasets: [
      {
        ...
        data: !data[0]
          ? null
          : data[0].countrySummary.map((n: CountrySummary) => n.TotalDeaths),
      },
    ],
  };
  ...
  return (
    <div>
      <CustomSecondaryContainer>
        <CustomTitle title="Total deaths by Country" />
      </CustomSecondaryContainer>
      <CustomSecondaryContainer>
        <Doughnut
          data={dataSource}
