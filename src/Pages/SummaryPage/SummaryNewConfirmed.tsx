...
export default function SummaryNewConfirmed() {
  const url = `${process.env.REACT_APP_BASE_URL}/countriessummary/new/confirmed`;
    ...
    datasets: [
      {
        ...
        data: !data[0]
          ? null
          : data[0].countrySummary.map((n: CountrySummary) => n.NewConfirmed),
      },
    ],
  };
  ...
  return (
    <div>
      <CustomSecondaryContainer>
        <CustomTitle title="New confirmed by Country" />
      </CustomSecondaryContainer>
      <CustomSecondaryContainer>
        <Doughnut
          data={dataSource}
